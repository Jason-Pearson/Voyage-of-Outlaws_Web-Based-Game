module objects {
    export class Hunters extends objects.GameObject { // Enemy class/controller - extends to objects.Gameobject, making a variable of this type holding the Barrel sprite/gameobject
        ...
        //CONTRUCTOR
        constructor() {
            super("AssaultboatB"); // makes a super call to the GameObject class, gives imageString value to refer to Leviathan in the Atlus SpriteSheet variable
