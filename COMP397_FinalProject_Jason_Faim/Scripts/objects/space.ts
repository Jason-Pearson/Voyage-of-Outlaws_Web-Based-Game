module objects {
    export class Space extends createjs.Bitmap { // Ocean class/controller - extends to createjs.Bitmap in order to reference the Ocean.png as a Bitmap throughout this class
        //PRIVATE INSTANCE VARIABLES
        private _dx: number; // the speed on the x-axis to which the Ocean will scroll

        //CONTRUCTOR
        constructor() {
            super(assets.getResult("Space")); // make a super call to the createjs.Bitmap class to hold the Ocean.png from the manifest in the assets variable (in game.ts)
