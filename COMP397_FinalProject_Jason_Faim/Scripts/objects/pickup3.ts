﻿module objects {
    ...
    export class Pickup3 extends objects.GameObject { // extends to gameobject class in order to create Barrel sprite/gameobject
        //PRIVATE INSTANCE VARIABLES
        private _dx: number; // the speed on the x-axis to which the Barrel will scroll

        //CONTRUCTOR
        constructor() {
            super("Box/Cross"); // makes a super call to the GameObject class, gives imageString value to refer to Barrel in the Atlus SpriteSheet variable
