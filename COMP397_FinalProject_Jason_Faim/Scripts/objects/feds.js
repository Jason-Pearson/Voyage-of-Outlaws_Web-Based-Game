...
(function (objects) {
    var Feds = (function (_super) {
        ...
        //CONTRUCTOR
        function Feds() {
            _super.call(this, "Spaceship_tut_small"); // makes a super call to the GameObject class, gives imageString value to refer to Leviathan in the Atlus SpriteSheet variable
